...
class Options
{
    ...
    [Option('o', "output", HelpText = "Output file name, if not specified, the program will use the input file name")]
    ...
    [Value(0, MetaName = "inputfile", Required = true, HelpText = "Input file name")]
